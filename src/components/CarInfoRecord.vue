    ...
    <div class="CarBody">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button
                  size="small"
                  type="warning"
                  @click="editVehicleData(scope.row.LicensePlate)">修改
              </el-button>
              <el-button
                  size="small"
                  type="danger"
                  @click="VehicleDelete(scope.row.LicensePlate)">删除
              </el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <el-dialog
          ...
          <el-form ref="form" :model="VehicleForm" label-width="80px">
              ...
              <el-form-item>
                  <el-button type="primary" @click="VehicleBaoCun(VehicleForm.LicensePlate,VehicleForm)">保存
                  </el-button>
...
export default {
  ...
  methods: {
    ...
    editVehicleData (index1, index2) {
      ...
      for (const i of store.VehicleData) {
