  ...
  <div class="RegManaList">
    ...
    <div class="lsit-lsit">
      <el-table :data="RegData" max-height="600" border style="width: 100%">
        ...
        <el-table-column align="center" prop="area" label="GPS"/>
    ...
    <el-dialog title="修改区域信息" :visible.sync="dialogRegVisible">
      <el-form ref="form" :model="RegForm" label-width="80px">
        <el-form-item label="区域编号">
          <el-input v-model="RegForm.num" disabled/>
        </el-form-item>
        <el-form-item label="区域名称">
          <el-input v-model="RegForm.label"/>
        </el-form-item>
        <el-form-item label="区域GPS">
          <el-input v-model="RegForm.GPS"/>
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model="RegForm.info"/>
        </el-form-item>
        <el-form-item>
